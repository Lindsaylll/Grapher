...
@rem ##########################################################################
@rem
@rem  a2-basic startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and A2_BASIC_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %A2_BASIC_OPTS%  -classpath "%CLASSPATH%" Main %*
...
:fail
rem Set variable A2_BASIC_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%A2_BASIC_EXIT_CONSOLE%" exit 1
exit /b 1
